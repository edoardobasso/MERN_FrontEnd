...
import { Form, Col, Card, Button, Image } from "react-bootstrap";
      ...
      <div>
        ...
        >
          <Form style={{ width: "70%" }}>
            ...
            <Form.Row>
              <Col>
                <Form.Control placeholder="Choose Username" required />
              </Col>
            </Form.Row>
            <span>
              <h3></h3>
            ...
            <Form.Row>
              <Col>
                <Form.Control placeholder="Choose Password" required />
              </Col>
            </Form.Row>
            <span>
              <h3></h3>
          ...
          <Button style={{ width: "70%", height: "40%" }}>Sign Up</Button>
        </Card>
      </div>
    );
  }
